# BUS 462 | Spring 2022 | 
# Session 10  AB Testing
# CK 
# 22 Mar 2021
# CAT WITH / WITHOUT THE HAT CASE
############################################################
...
total_Sample_size <- SSizeLogisticBin(p1= 0.54 ,# conversion rate in aug
                                      p2= 0.54 + .1, # you want to detect a +10% increase
...
#TODO how many observations for +5% increase in AUG?

# Now calculate for january, but 5% increase (p2)
total_Sample_size <- SSizeLogisticBin(p1= 0.197 ,# conversion rate in JAN
                                      p2= .197 + .05, # you want to detect a +5% increase
                                      B= 0.5, # proportion of sample for test
                                      alpha= .05,
                                      power= .8)
total_Sample_size
## This means you need 2167 experimental observations to detect a 10% increase in experiment sample  

#TODO Now try for 1% increase in JAN
